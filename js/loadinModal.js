(function ($) {
	...
	function createModal() {
		var modal = '<div class="modal fade modal-container container-iframe-modal" id="modalforiframe" role="dialog"><div class="modal-dialog modal-lg dialog-iframe-modal"><div class="modal-content content-iframe-modal"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h6 class="modal-title" id="myModalLabel">&nbsp;</h4></div><div id="modalIframe" class="modal-body"><div id="siteloader-content"><h3>Fetching Data From Device</h3><img id="loader" src="siteloader.gif"/></div></div></div></div></div></div>';		
		$('body').append(modal);
	}
